...
const projects = [
  ...
  },
  {
    ...
    image: "/images/screentime-plus.png",
...
export default function Projects() {
  return (
    <section id="projects" className="py-20 bg-sky-50/50 dark:bg-sky-950/10">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            ...
            >
              <Card className="h-full overflow-hidden group border-sky-200 hover:border-sky-500 dark:border-sky-800 dark:hover:border-sky-400 transition-colors shadow-lg dark:shadow-sky-500/10">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-sky-700 dark:text-sky-300">{project.title}</h3>
                ...
                <CardFooter className="p-6 pt-0 flex justify-between">
                  ...
                  <Button size="sm" className="gap-2 bg-sky-500 hover:bg-sky-600 text-white" asChild>
